    ...
    MoreJS.villagerTrades(event => {
        ...
        drugtrade('minecraft:cartographer',     2,  3,  'createbb:sudafed_box',      8,   16,    2)
        ...
        drugtrade('minecraft:librarian',        2,  3,  'createbb:sudafed_box',      8,   16,    2)
        drugtrade('minecraft:librarian',        1,  1,  'nirvana:weed_brownie',  8,   16,    1)
        drugtrade('minecraft:shepherd',         2,  3,  'createbb:white_meth',   4,   8,     2)
        drugtrade('minecraft:toolsmith',        1,  3,  'createbb:sudafed_box',      8,   16,    2)
